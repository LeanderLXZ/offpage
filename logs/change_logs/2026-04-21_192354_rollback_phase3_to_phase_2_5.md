...
- `git rm` 5 份 `阶段01_<stage_title>初遇.json`：
  - `world/stage_snapshots/`
  - `characters/Character A/canon/stage_snapshots/`
  - `characters/Character B/canon/stage_snapshots/`
  - `characters/Character A/canon/memory_timeline/`
  - `characters/Character B/canon/memory_timeline/`
- truncate 3 份 jsonl 到 0 字节（仍 tracked）：
  - `world/world_event_digest.jsonl`
  - `characters/Character A/canon/memory_digest.jsonl`
  - `characters/Character B/canon/memory_digest.jsonl`
- 清空 3 份 `stage_catalog.json` 的 `stages` 数组：
  - `world/stage_catalog.json`
  - `characters/Character A/canon/stage_catalog.json`
  - `characters/Character B/canon/stage_catalog.json`
...
- 5 份 `阶段01_<stage_title>初遇.json` 已从 index + working tree 移除
