...
- **Extraction anchor**: Phase 2 produces skeleton baselines from
...
- **Phase 2 (baseline production)**: `identity.json`, `manifest.json`,
  ...
  this stage.
- **Stage 1 (stage 1)**: review and correct all Phase 2 baseline drafts
