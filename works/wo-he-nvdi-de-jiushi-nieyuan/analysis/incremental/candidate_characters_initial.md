...
- first-pass mention stats:
  ...
  - across `534` chapters
- evidence anchors:
  - early direct interaction withCharacter A in `chapters/0006.txt`,
...
- short role:
  - primary female lead
  - central counterpart to Character B
...
- normalized name: `萧浩`
- aliases / other forms:
  - `徒儿` in relation to Character B
  - `死耗子` in Character E's speech
- importance: `high`
- short role:
  - major male supporting character
  - Character B's disciple
...
- evidence anchors:
  ...
  - recurring titled chapters `47`, `48`, `169`, `170`, `172`, `173`, `174`,
    `382`, `413`, `414`, `423`, `429`
  - relation dynamic with Character E visible in `chapters/0057.txt`

### 4. Character E

- normalized name: `Character E`
- aliases / other forms:
  - `妍儿`
- importance: `high`
- short role:
...
- evidence anchors:
  ...
  - grouped by Character B with 萧浩 and 冷凝月 in `chapters/0413.txt`
...
- importance: `high`
- short role:
  - important female supporting character from the <location> line
...
- evidence anchors:
  ...
  - later involved with Character F and仙界 transition in `chapters/0453.txt`,
    `chapters/0459.txt`

### 6. Character F

- normalized name: `Character F`
- aliases / other forms:
  - no stable alternate form validated yet beyond direct name use
- importance: `medium-high`
- short role:
  - important later-stage female supporting character
  - high-power仙界 figure with direct influence on Character A, Character B, and 冷凝月
- first-pass mention stats:
...
- normalized name: `Character I`
- aliases / other forms:
  - no stable alternate form validated yet
- importance: `medium`
- short role:
  - later-stage male supporting character
  - not central like Character B or Character A, but receives enough dedicated focus to
...
- short role:
  ...
  - appears tied to a multi-soul / confrontation line involving Character B and
    Character A
- first-pass mention stats:
...
- evidence anchors:
  ...
  - later appears around 冷凝月 and Character F in `chapters/0453.txt`,
    `chapters/0459.txt`
