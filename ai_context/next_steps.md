...
1. **Continue automated extraction for <work_id>.**
   - Phase 0 (summarization) and Phase 1 (analysis) are complete
   - Run: `cd automation && python -m persona_extraction "<work_id>" -r .. -c Character A Character B`
   ...
   - 40 batches total, target characters: Character A, Character B
