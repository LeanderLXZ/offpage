...
from ..core.llm_backend import LLMBackend, run_with_retry
from ..core.json_repair import programmatic_repair
from ..core.process_guard import PidLock
...
def _run_parallel(
    ...
    # [phase4] in extraction/config.toml. Independent of §11.13's token-
