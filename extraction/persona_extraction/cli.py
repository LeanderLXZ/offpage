...
from extraction.ingestion.validator import validate_source_package
from .core.config import get_config
from .core.git_utils import preflight_check
...
def main(argv: list[str] | None = None) -> None:
    ...
    # Mirrors `python -m extraction.ingestion.validator <work_id>` so users
